...
function buildPreviewData(proposal: DesignSpec): PublicGuideData {
  return {
    ...
    theme: {
      ...
      mutedColor: "#ece3d7",
      titleColor: "#2d2926",
      subtitleColor: "#756d66",
      cardTitleColor: "#2d2926",
      cardTextColor: "#2d2926",
      cardSubtitleColor: "#756d66",
    ...
    breakfast: null,
    conciergeInfo: null,
    concierge: { enabled: false, assistantName: "Concierge", welcomeMessage: "Olá! Como posso ajudar durante sua estadia?", avatarUrl: null },

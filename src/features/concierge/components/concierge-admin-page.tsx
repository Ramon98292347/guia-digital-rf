      ...
      <Card>
        ...
        <CardContent>
          <form action={saveSettings} className="grid gap-4 sm:grid-cols-2">
            ...
            <label><span className="mb-1.5 block text-sm font-medium">Nome do assistente</span><input name="assistant_name" defaultValue={stringValue(settings, "assistant_name", "Concierge")} className="h-10 w-full rounded-lg border px-3 text-sm" /></label>

    ...
    <div className="mx-auto max-w-6xl">
      <AccommodationForm
        ...
        initialValues={{
          ...
          areaM2: String((accommodation as unknown as { area_m2?: number | null }).area_m2 ?? ""),
          viewDescription: String((accommodation as unknown as { view_description?: string | null }).view_description ?? ""),
          bedDescription: String((accommodation as unknown as { bed_description?: string | null }).bed_description ?? ""),
